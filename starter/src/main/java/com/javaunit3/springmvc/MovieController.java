...
public class MovieController {
    ...
    public String addMovie(HttpServletRequest request) {
        ...
        // Checking if required parameters are empty or null
        if (movieTitle == null || movieTitle.isEmpty() ||
                maturityRating == null || maturityRating.isEmpty() ||
                genre == null || genre.isEmpty()) {
            // If any of the parameters are empty, simply return without adding to the database
            return "addMovie";
        }
